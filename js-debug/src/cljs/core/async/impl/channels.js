...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t48535 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t48535 = (function (val,box,meta48536){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t48535.cljs$lang$type = true;
cljs.core.async.impl.channels.t48535.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t48535";
cljs.core.async.impl.channels.t48535.cljs$lang$ctorPrWriter = (function (this__20455__auto__,writer__20456__auto__,opt__20457__auto__){return cljs.core._write(writer__20456__auto__,"cljs.core.async.impl.channels/t48535");
});
cljs.core.async.impl.channels.t48535.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t48535.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_48537){var self__ = this;
var _48537__$1 = this;return self__.meta48536;
});
cljs.core.async.impl.channels.t48535.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_48537,meta48536__$1){var self__ = this;
var _48537__$1 = this;return (new cljs.core.async.impl.channels.t48535(self__.val,self__.box,meta48536__$1));
});
cljs.core.async.impl.channels.__GT_t48535 = (function __GT_t48535(val__$1,box__$1,meta48536){return (new cljs.core.async.impl.channels.t48535(val__$1,box__$1,meta48536));
});
}
return (new cljs.core.async.impl.channels.t48535(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__20458__auto__,writer__20459__auto__,opts__20460__auto__){return cljs.core._write(writer__20459__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__20455__auto__,writer__20456__auto__,opt__20457__auto__){return cljs.core._write(writer__20456__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_48540 = self__.takes.pop();if((taker_48540 == null))
{} else
{if(taker_48540.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1(null))
{var take_cb_48541 = taker_48540.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (take_cb_48541,taker_48540,this$__$1){
return (function (){var G__48538 = null;return (take_cb_48541.cljs$core$IFn$_invoke$arity$1 ? take_cb_48541.cljs$core$IFn$_invoke$arity$1(G__48538) : take_cb_48541.call(null,G__48538));
});})(take_cb_48541,taker_48540,this$__$1))
);
} else
{}
{
...
return (function (){var G__48539 = val;return (take_cb.cljs$core$IFn$_invoke$arity$1 ? take_cb.cljs$core$IFn$_invoke$arity$1(G__48539) : take_cb.call(null,G__48539));
