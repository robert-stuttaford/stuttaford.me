...
{return s.replace((new RegExp((function (){var G__66947 = match;return goog.string.regExpEscape(G__66947);
})(),"g")),replacement);
} else
...
{{
var G__66948 = cljs.core.pop(v__$1);
v__$1 = G__66948;
continue;
}
} else
...
{var pred__66956 = cljs.core._EQ_;var expr__66957 = limit;if(cljs.core.truth_((function (){var G__66959 = (1);var G__66960 = expr__66957;return (pred__66956.cljs$core$IFn$_invoke$arity$2 ? pred__66956.cljs$core$IFn$_invoke$arity$2(G__66959,G__66960) : pred__66956.call(null,G__66959,G__66960));
})()))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((function (){var G__66961 = (2);var G__66962 = expr__66957;return (pred__66956.cljs$core$IFn$_invoke$arity$2 ? pred__66956.cljs$core$IFn$_invoke$arity$2(G__66961,G__66962) : pred__66956.call(null,G__66961,G__66962));
})()))
...
var G__66966 = s__$1.substring((index + cljs.core.count(m)));
var G__66967 = (limit__$1 - (1));
var G__66968 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__66966;
limit__$1 = G__66967;
parts = G__66968;
continue;
...
*/
clojure.string.trim = (function trim(s){var G__66970 = s;return goog.string.trim(G__66970);
});
/**
* Removes whitespace from the left side of string.
*/
clojure.string.triml = (function triml(s){var G__66972 = s;return goog.string.trimLeft(G__66972);
});
/**
* Removes whitespace from the right side of string.
*/
clojure.string.trimr = (function trimr(s){var G__66974 = s;return goog.string.trimRight(G__66974);
});
/**
...
*/
clojure.string.blank_QMARK_ = (function blank_QMARK_(s){var G__66977 = s;return goog.string.isEmptySafe(G__66977);
});
/**
...
{var ch = s.charAt(index);var temp__4124__auto___66978 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4124__auto___66978))
{var replacement_66979 = temp__4124__auto___66978;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_66979)));
} else
{buffer.append(ch);
}
{
var G__66980 = (index + (1));
index = G__66980;
continue;
}
}
