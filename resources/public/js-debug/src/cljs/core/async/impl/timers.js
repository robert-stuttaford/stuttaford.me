...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__20439__auto__,writer__20440__auto__,opt__20441__auto__){return cljs.core._write(writer__20440__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_42052 = (0);while(true){
if((i_42052 < arr.length))
{(arr[i_42052] = null);
{
var G__42053 = (i_42052 + (1));
i_42052 = G__42053;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__20439__auto__,writer__20440__auto__,opt__20441__auto__){return cljs.core._write(writer__20440__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_42065 = (self__.level + (1));while(true){
if((i_42065 <= (new_level + (1))))
{(update[i_42065] = self__.header);
{
var G__42066 = (i_42065 + (1));
i_42065 = G__42066;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_42067 = (0);while(true){
if((i_42067 <= self__.level))
{var links_42068 = (update[i_42067]).forward;if(((links_42068[i_42067]) === x__$1))
{(links_42068[i_42067] = (x__$1.forward[i_42067]));
{
var G__42069 = (i_42067 + (1));
i_42067 = G__42069;
continue;
}
} else
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__19289__auto__ = (cljs.core.truth_((function (){var and__19277__auto__ = me;if(cljs.core.truth_(and__19277__auto__))
