...
{return s.replace((new RegExp((function (){var G__39297 = match;return goog.string.regExpEscape(G__39297);
})(),"g")),replacement);
} else
...
{{
var G__39298 = cljs.core.pop(v__$1);
v__$1 = G__39298;
continue;
}
} else
...
{var pred__39306 = cljs.core._EQ_;var expr__39307 = limit;if(cljs.core.truth_((function (){var G__39309 = (1);var G__39310 = expr__39307;return (pred__39306.cljs$core$IFn$_invoke$arity$2 ? pred__39306.cljs$core$IFn$_invoke$arity$2(G__39309,G__39310) : pred__39306.call(null,G__39309,G__39310));
})()))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((function (){var G__39311 = (2);var G__39312 = expr__39307;return (pred__39306.cljs$core$IFn$_invoke$arity$2 ? pred__39306.cljs$core$IFn$_invoke$arity$2(G__39311,G__39312) : pred__39306.call(null,G__39311,G__39312));
})()))
...
var G__39316 = s__$1.substring((index + cljs.core.count(m)));
var G__39317 = (limit__$1 - (1));
var G__39318 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__39316;
limit__$1 = G__39317;
parts = G__39318;
continue;
...
*/
clojure.string.trim = (function trim(s){var G__39320 = s;return goog.string.trim(G__39320);
});
/**
* Removes whitespace from the left side of string.
*/
clojure.string.triml = (function triml(s){var G__39322 = s;return goog.string.trimLeft(G__39322);
});
/**
* Removes whitespace from the right side of string.
*/
clojure.string.trimr = (function trimr(s){var G__39324 = s;return goog.string.trimRight(G__39324);
});
/**
...
*/
clojure.string.blank_QMARK_ = (function blank_QMARK_(s){var G__39327 = s;return goog.string.isEmptySafe(G__39327);
});
/**
...
{var ch = s.charAt(index);var temp__4124__auto___39328 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4124__auto___39328))
{var replacement_39329 = temp__4124__auto___39328;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_39329)));
} else
{buffer.append(ch);
}
{
var G__39330 = (index + (1));
index = G__39330;
continue;
}
}
