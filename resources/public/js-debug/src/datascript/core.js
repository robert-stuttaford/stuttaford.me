...
datascript.core.Datom.cljs$lang$ctorPrSeq = (function (this__20550__auto__){return cljs.core._conj(cljs.core.List.EMPTY,"datascript.core/Datom");
});
datascript.core.Datom.cljs$lang$ctorPrWriter = (function (this__20550__auto__,writer__20551__auto__){return cljs.core._write(writer__20551__auto__,"datascript.core/Datom");
});
...
datascript.core.Datom.prototype.cljs$core$IHash$_hash$arity$1 = (function (d){var d__$1 = this;var or__19357__auto__ = d__$1.__hash;if(cljs.core.truth_(or__19357__auto__))
...
datascript.core._search = (function _search(data,pattern){if((function (){var and__19335__auto__ = data;if(and__19335__auto__)
...
{var x__20559__auto__ = (((data == null))?null:data);return (function (){var or__19357__auto__ = (datascript.core._search[(function (){var G__36947 = x__20559__auto__;return goog.typeOf(G__36947);
})()]);if(or__19357__auto__)
{return or__19357__auto__;
} else
{var or__19357__auto____$1 = (datascript.core._search["_"]);if(or__19357__auto____$1)
...
datascript.core.cmp = (function cmp(o1,o2){if(cljs.core.truth_((function (){var and__19335__auto__ = o1;if(cljs.core.truth_(and__19335__auto__))
{return o2;
} else
{return and__19335__auto__;
}
...
datascript.core.cmp_datoms_eavt = (function cmp_datoms_eavt(d1,d2){var c__21195__auto__ = datascript.core.cmp(d1.e,d2.e);if(((0) === c__21195__auto__))
{var c__21195__auto____$1 = datascript.core.cmp(d1.a,d2.a);if(((0) === c__21195__auto____$1))
{var c__21195__auto____$2 = datascript.core.cmp_val(d1.v,d2.v);if(((0) === c__21195__auto____$2))
{var c__21195__auto____$3 = datascript.core.cmp(d1.tx,d2.tx);if(((0) === c__21195__auto____$3))
{return (0);
} else
{return c__21195__auto____$3;
}
} else
{return c__21195__auto____$2;
}
} else
{return c__21195__auto____$1;
}
} else
{return c__21195__auto__;
}
});
datascript.core.cmp_datoms_aevt = (function cmp_datoms_aevt(d1,d2){var c__21195__auto__ = datascript.core.cmp(d1.a,d2.a);if(((0) === c__21195__auto__))
{var c__21195__auto____$1 = datascript.core.cmp(d1.e,d2.e);if(((0) === c__21195__auto____$1))
{var c__21195__auto____$2 = datascript.core.cmp_val(d1.v,d2.v);if(((0) === c__21195__auto____$2))
{var c__21195__auto____$3 = datascript.core.cmp(d1.tx,d2.tx);if(((0) === c__21195__auto____$3))
{return (0);
} else
...
datascript.core.cmp_datoms_avet = (function cmp_datoms_avet(d1,d2){var c__21195__auto__ = datascript.core.cmp(d1.a,d2.a);if(((0) === c__21195__auto__))
{var c__21195__auto____$1 = datascript.core.cmp_val(d1.v,d2.v);if(((0) === c__21195__auto____$1))
{var c__21195__auto____$2 = datascript.core.cmp(d1.e,d2.e);if(((0) === c__21195__auto____$2))
{var c__21195__auto____$3 = datascript.core.cmp(d1.tx,d2.tx);if(((0) === c__21195__auto____$3))
{return (0);
} else
{return c__21195__auto____$3;
...
datascript.core.DB.cljs$lang$ctorPrSeq = (function (this__20550__auto__){return cljs.core._conj(cljs.core.List.EMPTY,"datascript.core/DB");
});
datascript.core.DB.cljs$lang$ctorPrWriter = (function (this__20550__auto__,writer__20551__auto__){return cljs.core._write(writer__20551__auto__,"datascript.core/DB");
});
...
datascript.core.equiv_index = (function equiv_index(x,y){var and__19335__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(x),cljs.core.count(y));if(and__19335__auto__)
...
datascript.core.DB.prototype.cljs$core$IHash$_hash$arity$1 = (function (this$){var this$__$1 = this;var or__19357__auto__ = this$__$1.__hash;if(cljs.core.truth_(or__19357__auto__))
{return or__19357__auto__;
} else
...
datascript.core.TxReport.cljs$lang$ctorPrSeq = (function (this__20550__auto__){return cljs.core._conj(cljs.core.List.EMPTY,"datascript.core/TxReport");
});
datascript.core.TxReport.cljs$lang$ctorPrWriter = (function (this__20550__auto__,writer__20551__auto__){return cljs.core._write(writer__20551__auto__,"datascript.core/TxReport");
});
...
datascript.core.explode = (function explode(db,entity){var eid = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(entity);var iter__20735__auto__ = ((function (eid){
...
{var xs__4624__auto__ = temp__4126__auto__;var vec__37022 = cljs.core.first(xs__4624__auto__);var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37022,(0),null);var vs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37022,(1),null);var iterys__20730__auto__ = ((function (s__37013__$1,vec__37022,a,vs,xs__4624__auto__,temp__4126__auto__,eid){
...
{var c__20733__auto__ = cljs.core.chunk_first(s__37015__$2);var size__20734__auto__ = cljs.core.count(c__20733__auto__);var b__37017 = cljs.core.chunk_buffer(size__20734__auto__);if((function (){var i__37016 = (0);while(true){
if((i__37016 < size__20734__auto__))
{var v = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__20733__auto__,i__37016);cljs.core.chunk_append(b__37017,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),eid,a,v], null));
{
...
;var fs__20731__auto__ = cljs.core.seq(iterys__20730__auto__(((((vs instanceof Array) || (cljs.core.coll_QMARK_(vs))) && (!(cljs.core.map_QMARK_(vs))) && (datascript.core.multival_QMARK_(db,a)))?vs:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [vs], null))));if(fs__20731__auto__)
{return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__20731__auto__,iter__37012(cljs.core.rest(s__37013__$1)));
} else
{{
...
;return iter__20735__auto__(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(entity,new cljs.core.Keyword("db","id","db/id",-1388397098)));
});
