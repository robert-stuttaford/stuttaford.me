...
{var G__41593 = bytes;var G__41594 = false;return goog.crypt.base64.encodeString(G__41593,G__41594);
} else
{return null;
}
});
...
{var G__41597 = s;var G__41598 = false;return goog.crypt.base64.decodeString(G__41597,G__41598);
} else
{return null;
}
});
...
var url_encode__delegate = function (s,p__41599){var vec__41602 = p__41599;var encoding = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41602,(0),null);if(cljs.core.truth_(s))
{return clojure.string.replace((function (){var G__41603 = (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));return encodeURIComponent(G__41603);
})(),"*","%2A");
} else
{return null;
}
...
var p__41599 = null;if (arguments.length > 1) {
  p__41599 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return url_encode__delegate.call(this,s,p__41599);};
url_encode.cljs$lang$maxFixedArity = 1;
url_encode.cljs$lang$applyTo = (function (arglist__41604){
var s = cljs.core.first(arglist__41604);
var p__41599 = cljs.core.rest(arglist__41604);
return url_encode__delegate(s,p__41599);
});
...
var url_decode__delegate = function (s,p__41605){var vec__41608 = p__41605;var encoding = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41608,(0),null);if(cljs.core.truth_(s))
{var G__41609 = s;return decodeURIComponent(G__41609);
} else
{return null;
}
};
var url_decode = function (s,var_args){
var p__41605 = null;if (arguments.length > 1) {
  p__41605 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return url_decode__delegate.call(this,s,p__41605);};
url_decode.cljs$lang$maxFixedArity = 1;
url_decode.cljs$lang$applyTo = (function (arglist__41610){
var s = cljs.core.first(arglist__41610);
var p__41605 = cljs.core.rest(arglist__41610);
return url_decode__delegate(s,p__41605);
});
...
{var G__41613 = clojure.string.upper_case(unit);switch (G__41613) {
default:
var G__41614 = unit;switch (G__41614) {
case "M":
...
{var matches = temp__4124__auto__;var number = (function (){var G__41619 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(matches,(1));return (parse_fn.cljs$core$IFn$_invoke$arity$1 ? parse_fn.cljs$core$IFn$_invoke$arity$1(G__41619) : parse_fn.call(null,G__41619));
})();var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(matches,(3));if(cljs.core.not((function (){var G__41620 = number;return isNaN(G__41620);
})()))
...
*/
no.en.core.parse_integer = (function parse_integer(s){return no.en.core.parse_number(s,(function (p1__41621_SHARP_){var G__41623 = p1__41621_SHARP_;return parseInt(G__41623);
}));
});
/**
* Parse `s` as a long number.
*/
no.en.core.parse_long = (function parse_long(s){return no.en.core.parse_number(s,(function (p1__41624_SHARP_){var G__41626 = p1__41624_SHARP_;return parseInt(G__41626);
}));
});
/**
* Parse `s` as a double number.
*/
no.en.core.parse_double = (function parse_double(s){return no.en.core.parse_number(s,(function (p1__41627_SHARP_){var G__41629 = p1__41627_SHARP_;return parseFloat(G__41629);
}));
});
/**
* Parse `s` as a float number.
*/
no.en.core.parse_float = (function parse_float(s){return no.en.core.parse_number(s,(function (p1__41630_SHARP_){var G__41632 = p1__41630_SHARP_;return parseFloat(G__41632);
}));
});
/**
* Format the map `m` into a query parameter string.
*/
no.en.core.format_query_params = (function format_query_params(m){var params = clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41635_SHARP_){return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__41635_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41634_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[no.en.core.url_encode(cljs.core.name(cljs.core.first(p1__41634_SHARP_))),no.en.core.url_encode(cljs.core.second(p1__41634_SHARP_))],null));
}),cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__41633_SHARP_){return clojure.string.blank_QMARK_((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second(p1__41633_SHARP_))));
...
{var query_params = new cljs.core.Keyword(null,"query-params","query-params",900640534).cljs$core$IFn$_invoke$arity$1(m);return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(new cljs.core.Keyword(null,"scheme","scheme",90199613).cljs$core$IFn$_invoke$arity$1(m))?(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name(new cljs.core.Keyword(null,"scheme","scheme",90199613).cljs$core$IFn$_invoke$arity$1(m)))+"://"):null))+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var map__41638 = m;var map__41638__$1 = ((cljs.core.seq_QMARK_(map__41638))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41638):map__41638);var password = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41638__$1,new cljs.core.Keyword(null,"password","password",417022471));var user = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41638__$1,new cljs.core.Keyword(null,"user","user",1532431356));if(cljs.core.truth_(user))
...
{var port = temp__4124__auto__;if(!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(port,(function (){var G__41639 = new cljs.core.Keyword(null,"scheme","scheme",90199613).cljs$core$IFn$_invoke$arity$1(m);return (no.en.core.port_number.cljs$core$IFn$_invoke$arity$1 ? no.en.core.port_number.cljs$core$IFn$_invoke$arity$1(G__41639) : no.en.core.port_number.call(null,G__41639));
})())))
...
{return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__41642_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(no.en.core.url_decode(cljs.core.first(p1__41642_SHARP_))),no.en.core.url_decode(cljs.core.second(p1__41642_SHARP_))],null));
}),cljs.core.array_seq([cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__41641_SHARP_){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((2),cljs.core.count(p1__41641_SHARP_));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41640_SHARP_){return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__41640_SHARP_,/=/);
...
{var G__41644 = scheme;return (no.en.core.port_number.cljs$core$IFn$_invoke$arity$1 ? no.en.core.port_number.cljs$core$IFn$_invoke$arity$1(G__41644) : no.en.core.port_number.call(null,G__41644));
}
...
{var result = temp__4124__auto__;var G__41648 = (0);return (result.cljs$core$IFn$_invoke$arity$1 ? result.cljs$core$IFn$_invoke$arity$1(G__41648) : result.call(null,G__41648));
} else
{{
var G__41649 = (n__$1 - (1));
n__$1 = G__41649;
continue;
}
}
