...
{var G__30959 = bytes;var G__30960 = false;return goog.crypt.base64.encodeString(G__30959,G__30960);
} else
{return null;
}
});
...
{var G__30963 = s;var G__30964 = false;return goog.crypt.base64.decodeString(G__30963,G__30964);
} else
{return null;
}
});
...
var url_encode__delegate = function (s,p__30965){var vec__30968 = p__30965;var encoding = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30968,(0),null);if(cljs.core.truth_(s))
{return clojure.string.replace((function (){var G__30969 = (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));return encodeURIComponent(G__30969);
})(),"*","%2A");
} else
{return null;
}
...
var p__30965 = null;if (arguments.length > 1) {
  p__30965 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return url_encode__delegate.call(this,s,p__30965);};
url_encode.cljs$lang$maxFixedArity = 1;
url_encode.cljs$lang$applyTo = (function (arglist__30970){
var s = cljs.core.first(arglist__30970);
var p__30965 = cljs.core.rest(arglist__30970);
return url_encode__delegate(s,p__30965);
});
...
var url_decode__delegate = function (s,p__30971){var vec__30974 = p__30971;var encoding = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30974,(0),null);if(cljs.core.truth_(s))
{var G__30975 = s;return decodeURIComponent(G__30975);
} else
{return null;
}
};
var url_decode = function (s,var_args){
var p__30971 = null;if (arguments.length > 1) {
  p__30971 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return url_decode__delegate.call(this,s,p__30971);};
url_decode.cljs$lang$maxFixedArity = 1;
url_decode.cljs$lang$applyTo = (function (arglist__30976){
var s = cljs.core.first(arglist__30976);
var p__30971 = cljs.core.rest(arglist__30976);
return url_decode__delegate(s,p__30971);
});
...
{var G__30979 = clojure.string.upper_case(unit);switch (G__30979) {
default:
var G__30980 = unit;switch (G__30980) {
case "M":
...
{var matches = temp__4124__auto__;var number = (function (){var G__30985 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(matches,(1));return (parse_fn.cljs$core$IFn$_invoke$arity$1 ? parse_fn.cljs$core$IFn$_invoke$arity$1(G__30985) : parse_fn.call(null,G__30985));
})();var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(matches,(3));if(cljs.core.not((function (){var G__30986 = number;return isNaN(G__30986);
})()))
...
*/
no.en.core.parse_integer = (function parse_integer(s){return no.en.core.parse_number(s,(function (p1__30987_SHARP_){var G__30989 = p1__30987_SHARP_;return parseInt(G__30989);
}));
});
/**
* Parse `s` as a long number.
*/
no.en.core.parse_long = (function parse_long(s){return no.en.core.parse_number(s,(function (p1__30990_SHARP_){var G__30992 = p1__30990_SHARP_;return parseInt(G__30992);
}));
});
/**
* Parse `s` as a double number.
*/
no.en.core.parse_double = (function parse_double(s){return no.en.core.parse_number(s,(function (p1__30993_SHARP_){var G__30995 = p1__30993_SHARP_;return parseFloat(G__30995);
}));
});
/**
* Parse `s` as a float number.
*/
no.en.core.parse_float = (function parse_float(s){return no.en.core.parse_number(s,(function (p1__30996_SHARP_){var G__30998 = p1__30996_SHARP_;return parseFloat(G__30998);
}));
});
/**
* Format the map `m` into a query parameter string.
*/
no.en.core.format_query_params = (function format_query_params(m){var params = clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31001_SHARP_){return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__31001_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31000_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[no.en.core.url_encode(cljs.core.name(cljs.core.first(p1__31000_SHARP_))),no.en.core.url_encode(cljs.core.second(p1__31000_SHARP_))],null));
}),cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__30999_SHARP_){return clojure.string.blank_QMARK_((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second(p1__30999_SHARP_))));
...
{var query_params = new cljs.core.Keyword(null,"query-params","query-params",900640534).cljs$core$IFn$_invoke$arity$1(m);return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(new cljs.core.Keyword(null,"scheme","scheme",90199613).cljs$core$IFn$_invoke$arity$1(m))?(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name(new cljs.core.Keyword(null,"scheme","scheme",90199613).cljs$core$IFn$_invoke$arity$1(m)))+"://"):null))+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var map__31004 = m;var map__31004__$1 = ((cljs.core.seq_QMARK_(map__31004))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__31004):map__31004);var password = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31004__$1,new cljs.core.Keyword(null,"password","password",417022471));var user = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31004__$1,new cljs.core.Keyword(null,"user","user",1532431356));if(cljs.core.truth_(user))
...
{var port = temp__4124__auto__;if(!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(port,(function (){var G__31005 = new cljs.core.Keyword(null,"scheme","scheme",90199613).cljs$core$IFn$_invoke$arity$1(m);return (no.en.core.port_number.cljs$core$IFn$_invoke$arity$1 ? no.en.core.port_number.cljs$core$IFn$_invoke$arity$1(G__31005) : no.en.core.port_number.call(null,G__31005));
})())))
...
{return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__31008_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(no.en.core.url_decode(cljs.core.first(p1__31008_SHARP_))),no.en.core.url_decode(cljs.core.second(p1__31008_SHARP_))],null));
}),cljs.core.array_seq([cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__31007_SHARP_){return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((2),cljs.core.count(p1__31007_SHARP_));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31006_SHARP_){return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__31006_SHARP_,/=/);
...
{var result = temp__4124__auto__;var G__31014 = (0);return (result.cljs$core$IFn$_invoke$arity$1 ? result.cljs$core$IFn$_invoke$arity$1(G__31014) : result.call(null,G__31014));
} else
{{
var G__31015 = (n__$1 - (1));
n__$1 = G__31015;
continue;
}
}
