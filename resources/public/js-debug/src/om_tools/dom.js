...
*/
om_tools.dom.opt_key_case = (function opt_key_case(attr){if(cljs.core.truth_((function (){var or__19357__auto__ = (cljs.core.count(attr) < (5));if(or__19357__auto__)
...
*/
om_tools.dom.opt_key_alias = (function opt_key_alias(opt){var G__38214 = (((opt instanceof cljs.core.Keyword))?opt.fqn:null);switch (G__38214) {
case "for":
...
{var G__38217 = opt_val;return (om_tools.dom.format_opts.cljs$core$IFn$_invoke$arity$1 ? om_tools.dom.format_opts.cljs$core$IFn$_invoke$arity$1(G__38217) : om_tools.dom.format_opts.call(null,G__38217));
} else
{return opt_val;
...
{return cljs.core.clj__GT_js(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__38220){var vec__38221 = p__38220;var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38221,(0),null);var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38221,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [om_tools.dom.format_opt_key(k),om_tools.dom.format_opt_val(v)], null);
}),opts)));
} else
{return opts;
}
...
om_tools.dom.element = (function element(ctor,opts,children){var vec__38223 = om_tools.dom.element_args(opts,children);var opts__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38223,(0),null);var children__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38223,(1),null);return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(ctor,cljs.core.flatten(cljs.core.cons(opts__$1,children__$1)));
});
