...
goog.require('sablono.util');
goog.require('clojure.string');
sablono.interpreter.IInterpreter = (function (){var obj53755 = {};return obj53755;
})();
sablono.interpreter.interpret = (function interpret(this$){if((function (){var and__19267__auto__ = this$;if(and__19267__auto__)
...
{var x__20529__auto__ = (((this$ == null))?null:this$);return (function (){var or__19289__auto__ = (sablono.interpreter.interpret[(function (){var G__53759 = x__20529__auto__;return goog.typeOf(G__53759);
...
sablono.interpreter.wrap_form_element = (function wrap_form_element(ctor,display_name){var G__53763 = {"render": (function (){var this$ = this;return this$.transferPropsTo((function (){var G__53765 = {"children": (this$.props["children"]), "onChange": (this$["onChange"]), "value": (this$.state["value"])};return (ctor.cljs$core$IFn$_invoke$arity$1 ? ctor.cljs$core$IFn$_invoke$arity$1(G__53765) : ctor.call(null,G__53765));
})());
...
{var G__53764_53766 = e;(handler.cljs$core$IFn$_invoke$arity$1 ? handler.cljs$core$IFn$_invoke$arity$1(G__53764_53766) : handler.call(null,G__53764_53766));
return this$.setState({"value": e.target.value});
}
}), "getInitialState": (function (){var this$ = this;return {"value": (this$.props["value"])};
}), "getDisplayName": (function (){return display_name;
})};return React.createClass(G__53763);
});
...
*/
sablono.interpreter.element = (function element(element__$1){var vec__53772 = sablono.util.normalize_element(element__$1);var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53772,(0),null);var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53772,(1),null);var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53772,(2),null);var f = sablono.interpreter.dom_fn(tag);var js_attrs = sablono.interpreter.attributes(attrs);if((cljs.core.sequential_QMARK_(content)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(content))))
{var G__53773 = js_attrs;var G__53774 = sablono.interpreter.interpret(cljs.core.first(content));return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__53773,G__53774) : f.call(null,G__53773,G__53774));
} else
{if(cljs.core.truth_(content))
{return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,js_attrs,sablono.interpreter.interpret(content));
} else
{var G__53775 = js_attrs;var G__53776 = null;return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__53775,G__53776) : f.call(null,G__53775,G__53776));
