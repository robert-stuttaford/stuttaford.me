...
goog.require('sablono.util');
goog.require('clojure.string');
sablono.interpreter.IInterpreter = (function (){var obj36492 = {};return obj36492;
})();
sablono.interpreter.interpret = (function interpret(this$){if((function (){var and__19255__auto__ = this$;if(and__19255__auto__)
...
{var x__20512__auto__ = (((this$ == null))?null:this$);return (function (){var or__19267__auto__ = (sablono.interpreter.interpret[(function (){var G__36496 = x__20512__auto__;return goog.typeOf(G__36496);
})()]);if(or__19267__auto__)
{return or__19267__auto__;
} else
{var or__19267__auto____$1 = (sablono.interpreter.interpret["_"]);if(or__19267__auto____$1)
...
sablono.interpreter.wrap_form_element = (function wrap_form_element(ctor,display_name){var G__36500 = {"render": (function (){var this$ = this;return this$.transferPropsTo((function (){var G__36502 = {"children": (this$.props["children"]), "onChange": (this$["onChange"]), "value": (this$.state["value"])};return (ctor.cljs$core$IFn$_invoke$arity$1 ? ctor.cljs$core$IFn$_invoke$arity$1(G__36502) : ctor.call(null,G__36502));
})());
...
{var G__36501_36503 = e;(handler.cljs$core$IFn$_invoke$arity$1 ? handler.cljs$core$IFn$_invoke$arity$1(G__36501_36503) : handler.call(null,G__36501_36503));
return this$.setState({"value": e.target.value});
}
}), "getInitialState": (function (){var this$ = this;return {"value": (this$.props["value"])};
}), "getDisplayName": (function (){return display_name;
})};return React.createClass(G__36500);
});
...
*/
sablono.interpreter.element = (function element(element__$1){var vec__36509 = sablono.util.normalize_element(element__$1);var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36509,(0),null);var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36509,(1),null);var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36509,(2),null);var f = sablono.interpreter.dom_fn(tag);var js_attrs = sablono.interpreter.attributes(attrs);if((cljs.core.sequential_QMARK_(content)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(content))))
{var G__36510 = js_attrs;var G__36511 = sablono.interpreter.interpret(cljs.core.first(content));return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__36510,G__36511) : f.call(null,G__36510,G__36511));
} else
{if(cljs.core.truth_(content))
{return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,js_attrs,sablono.interpreter.interpret(content));
} else
{var G__36512 = js_attrs;var G__36513 = null;return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__36512,G__36513) : f.call(null,G__36512,G__36513));
