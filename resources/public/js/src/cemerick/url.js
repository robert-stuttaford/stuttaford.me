...
cemerick.url.URL.cljs$lang$ctorPrSeq = (function (this__20561__auto__){return cljs.core._conj(cljs.core.List.EMPTY,"cemerick.url/URL");
});
cemerick.url.URL.cljs$lang$ctorPrWriter = (function (this__20561__auto__,writer__20562__auto__){return cljs.core._write(writer__20562__auto__,"cemerick.url/URL");
});
...
cemerick.url.url_STAR_ = (function url_STAR_(url){var url__$1 = (new goog.Uri(url));var vec__30644 = clojure.string.split.cljs$core$IFn$_invoke$arity$3((function (){var or__19347__auto__ = url__$1.getUserInfo();if(cljs.core.truth_(or__19347__auto__))
{return or__19347__auto__;
} else
{return "";
}
})(),/:/,(2));var user = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30644,(0),null);var pass = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30644,(1),null);return (new cemerick.url.URL(url__$1.getScheme(),(function (){var and__19325__auto__ = cljs.core.seq(user);if(and__19325__auto__)
{return user;
} else
{return and__19325__auto__;
}
})(),(function (){var and__19325__auto__ = cljs.core.seq(pass);if(and__19325__auto__)
{return pass;
} else
{return and__19325__auto__;
}
