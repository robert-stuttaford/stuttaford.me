...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t31581 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t31581 = (function (val,box,meta31582){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t31581.cljs$lang$type = true;
cljs.core.async.impl.channels.t31581.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t31581";
cljs.core.async.impl.channels.t31581.cljs$lang$ctorPrWriter = (function (this__20766__auto__,writer__20767__auto__,opt__20768__auto__){return cljs.core._write(writer__20767__auto__,"cljs.core.async.impl.channels/t31581");
});
cljs.core.async.impl.channels.t31581.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t31581.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_31583){var self__ = this;
var _31583__$1 = this;return self__.meta31582;
});
cljs.core.async.impl.channels.t31581.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_31583,meta31582__$1){var self__ = this;
var _31583__$1 = this;return (new cljs.core.async.impl.channels.t31581(self__.val,self__.box,meta31582__$1));
});
cljs.core.async.impl.channels.__GT_t31581 = (function __GT_t31581(val__$1,box__$1,meta31582){return (new cljs.core.async.impl.channels.t31581(val__$1,box__$1,meta31582));
});
}
return (new cljs.core.async.impl.channels.t31581(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__20769__auto__,writer__20770__auto__,opts__20771__auto__){return cljs.core._write(writer__20770__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__20766__auto__,writer__20767__auto__,opt__20768__auto__){return cljs.core._write(writer__20767__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_31586 = self__.takes.pop();if((taker_31586 == null))
{} else
{if(taker_31586.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1(null))
{var take_cb_31587 = taker_31586.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (take_cb_31587,taker_31586,this$__$1){
return (function (){var G__31584 = null;return (take_cb_31587.cljs$core$IFn$_invoke$arity$1 ? take_cb_31587.cljs$core$IFn$_invoke$arity$1(G__31584) : take_cb_31587.call(null,G__31584));
});})(take_cb_31587,taker_31586,this$__$1))
);
} else
{}
{
...
return (function (){var G__31585 = val;return (take_cb.cljs$core$IFn$_invoke$arity$1 ? take_cb.cljs$core$IFn$_invoke$arity$1(G__31585) : take_cb.call(null,G__31585));
