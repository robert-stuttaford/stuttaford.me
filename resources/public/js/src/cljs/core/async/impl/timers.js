...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__20766__auto__,writer__20767__auto__,opt__20768__auto__){return cljs.core._write(writer__20767__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_31670 = (0);while(true){
if((i_31670 < arr.length))
{(arr[i_31670] = null);
{
var G__31671 = (i_31670 + (1));
i_31670 = G__31671;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__20766__auto__,writer__20767__auto__,opt__20768__auto__){return cljs.core._write(writer__20767__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_31683 = (self__.level + (1));while(true){
if((i_31683 <= (new_level + (1))))
{(update[i_31683] = self__.header);
{
var G__31684 = (i_31683 + (1));
i_31683 = G__31684;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_31685 = (0);while(true){
if((i_31685 <= self__.level))
{var links_31686 = (update[i_31685]).forward;if(((links_31686[i_31685]) === x__$1))
{(links_31686[i_31685] = (x__$1.forward[i_31685]));
{
var G__31687 = (i_31685 + (1));
i_31685 = G__31687;
continue;
}
} else
{{
var G__31688 = (i_31685 + (1));
i_31685 = G__31688;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__19663__auto__ = (cljs.core.truth_((function (){var and__19621__auto__ = me;if(cljs.core.truth_(and__19621__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__19621__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__19663__auto__))
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__19663__auto__,timeout__$1,me){
...
});})(timeout_channel,or__19663__auto__,timeout__$1,me))
,msecs);
