...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__19347__auto__ = (cljs.core.truth_((function (){var and__19325__auto__ = me;if(cljs.core.truth_(and__19325__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__19325__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__19347__auto__))
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__19347__auto__,timeout__$1,me){
...
});})(timeout_channel,or__19347__auto__,timeout__$1,me))
,msecs);
