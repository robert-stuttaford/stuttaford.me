...
cljs.reader.read_char = (function read_char(reader){if((function (){var and__19325__auto__ = reader;if(and__19325__auto__)
...
{var x__20576__auto__ = (((reader == null))?null:reader);return (function (){var or__19347__auto__ = (cljs.reader.read_char[(function (){var G__30653 = x__20576__auto__;return goog.typeOf(G__30653);
})()]);if(or__19347__auto__)
{return or__19347__auto__;
} else
{var or__19347__auto____$1 = (cljs.reader.read_char["_"]);if(or__19347__auto____$1)
...
cljs.reader.unread = (function unread(reader,ch){if((function (){var and__19325__auto__ = reader;if(and__19325__auto__)
...
{var x__20576__auto__ = (((reader == null))?null:reader);return (function (){var or__19347__auto__ = (cljs.reader.unread[(function (){var G__30657 = x__20576__auto__;return goog.typeOf(G__30657);
})()]);if(or__19347__auto__)
{return or__19347__auto__;
} else
{var or__19347__auto____$1 = (cljs.reader.unread["_"]);if(or__19347__auto____$1)
{return or__19347__auto____$1;
} else
...
*/
cljs.reader.whitespace_QMARK_ = (function whitespace_QMARK_(ch){var or__19347__auto__ = (function (){var G__30661 = ch;return goog.string.isBreakingWhitespace(G__30661);
...
;
cljs.reader.macro_terminating_QMARK_ = (function macro_terminating_QMARK_(ch){var and__19325__auto__ = !((ch === "#"));if(and__19325__auto__)
{var and__19325__auto____$1 = !((ch === "'"));if(and__19325__auto____$1)
{var and__19325__auto____$2 = !((ch === ":"));if(and__19325__auto____$2)
...
if(cljs.core.truth_((function (){var or__19347__auto__ = (ch == null);if(or__19347__auto__)
{return or__19347__auto__;
} else
{var or__19347__auto____$1 = cljs.reader.whitespace_QMARK_(ch);if(or__19347__auto____$1)
{return or__19347__auto____$1;
} else
...
var s = buffer.toString();var or__19347__auto__ = cljs.reader.match_number(s);if(cljs.core.truth_(or__19347__auto__))
{return or__19347__auto__;
} else
...
{var bit__20622__auto__ = (G__30775.cljs$lang$protocol_mask$partition0$ & (262144));if((bit__20622__auto__) || (G__30775.cljs$core$IWithMeta$))
{return true;
} else
...
{var years__$1 = cljs.reader.parse_int(years);var months__$1 = (function (){var or__19347__auto__ = cljs.reader.parse_int(months);if(cljs.core.truth_(or__19347__auto__))
{return or__19347__auto__;
} else
{return (1);
}
})();var days__$1 = (function (){var or__19347__auto__ = cljs.reader.parse_int(days);if(cljs.core.truth_(or__19347__auto__))
{return or__19347__auto__;
} else
{return (1);
}
})();var hours__$1 = (function (){var or__19347__auto__ = cljs.reader.parse_int(hours);if(cljs.core.truth_(or__19347__auto__))
{return or__19347__auto__;
} else
{return (0);
}
})();var minutes__$1 = (function (){var or__19347__auto__ = cljs.reader.parse_int(minutes);if(cljs.core.truth_(or__19347__auto__))
{return or__19347__auto__;
} else
{return (0);
}
})();var seconds__$1 = (function (){var or__19347__auto__ = cljs.reader.parse_int(seconds);if(cljs.core.truth_(or__19347__auto__))
{return or__19347__auto__;
} else
{return (0);
}
})();var fraction__$1 = (function (){var or__19347__auto__ = cljs.reader.parse_int(cljs.reader.zero_fill_right_and_truncate(fraction,(3)));if(cljs.core.truth_(or__19347__auto__))
{return or__19347__auto__;
} else
{return (0);
}
})();var offset_sign__$1 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(offset_sign,"-"))?(-1):(1));var offset_hours__$1 = (function (){var or__19347__auto__ = cljs.reader.parse_int(offset_hours);if(cljs.core.truth_(or__19347__auto__))
{return or__19347__auto__;
} else
{return (0);
}
})();var offset_minutes__$1 = (function (){var or__19347__auto__ = cljs.reader.parse_int(offset_minutes);if(cljs.core.truth_(or__19347__auto__))
{return or__19347__auto__;
} else
{return (0);
}
...
{var c__20813__auto___30858 = cljs.core.chunk_first(seq__30835_30857__$1);{
var G__30859 = cljs.core.chunk_rest(seq__30835_30857__$1);
var G__30860 = c__20813__auto___30858;
var G__30861 = cljs.core.count(c__20813__auto___30858);
var G__30862 = (0);
...
{var c__20813__auto___30881 = cljs.core.chunk_first(seq__30841_30880__$1);{
var G__30882 = cljs.core.chunk_rest(seq__30841_30880__$1);
var G__30883 = c__20813__auto___30881;
var G__30884 = cljs.core.count(c__20813__auto___30881);
var G__30885 = (0);
