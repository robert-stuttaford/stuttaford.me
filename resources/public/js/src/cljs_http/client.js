...
goog.require('cljs.reader');
goog.require('cljs_http.core');
cljs_http.client.if_pos = (function if_pos(v){if(cljs.core.truth_((function (){var and__19325__auto__ = v;if(cljs.core.truth_(and__19325__auto__))
{return (v > (0));
} else
...
*/
cljs_http.client.decode_body = (function decode_body(response,decode_fn,content_type,request_method){if(cljs.core.truth_((function (){var and__19325__auto__ = cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"head","head",-771383919),request_method);if(and__19325__auto__)
...
return (function (request){var temp__4124__auto__ = (function (){var or__19347__auto__ = new cljs.core.Keyword(null,"accept","accept",1874130431).cljs$core$IFn$_invoke$arity$1(request);if(cljs.core.truth_(or__19347__auto__))
...
return (function (request){var temp__4124__auto__ = (function (){var or__19347__auto__ = new cljs.core.Keyword(null,"content-type","content-type",-508222634).cljs$core$IFn$_invoke$arity$1(request);if(cljs.core.truth_(or__19347__auto__))
{return or__19347__auto__;
} else
{return content_type;
}
...
cljs_http.client.wrap_form_params = (function wrap_form_params(client){return (function (p__34399){var map__34400 = p__34399;var map__34400__$1 = ((cljs.core.seq_QMARK_(map__34400))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__34400):map__34400);var request = map__34400__$1;var request_method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34400__$1,new cljs.core.Keyword(null,"request-method","request-method",1764796830));var form_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34400__$1,new cljs.core.Keyword(null,"form-params","form-params",1884296467));if(cljs.core.truth_((function (){var and__19325__auto__ = form_params;if(cljs.core.truth_(and__19325__auto__))
...
return (function (req){var credentials__$1 = (function (){var or__19347__auto__ = new cljs.core.Keyword(null,"basic-auth","basic-auth",-673163332).cljs$core$IFn$_invoke$arity$1(req);if(cljs.core.truth_(or__19347__auto__))
{return or__19347__auto__;
} else
{return credentials;
}
