...
{return s.replace((new RegExp((function (){var G__30776 = match;return goog.string.regExpEscape(G__30776);
})(),"g")),replacement);
} else
...
{{
var G__30777 = cljs.core.pop(v__$1);
v__$1 = G__30777;
continue;
}
} else
...
{var pred__30785 = cljs.core._EQ_;var expr__30786 = limit;if(cljs.core.truth_((function (){var G__30788 = (1);var G__30789 = expr__30786;return (pred__30785.cljs$core$IFn$_invoke$arity$2 ? pred__30785.cljs$core$IFn$_invoke$arity$2(G__30788,G__30789) : pred__30785.call(null,G__30788,G__30789));
})()))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((function (){var G__30790 = (2);var G__30791 = expr__30786;return (pred__30785.cljs$core$IFn$_invoke$arity$2 ? pred__30785.cljs$core$IFn$_invoke$arity$2(G__30790,G__30791) : pred__30785.call(null,G__30790,G__30791));
})()))
...
var G__30795 = s__$1.substring((index + cljs.core.count(m)));
var G__30796 = (limit__$1 - (1));
var G__30797 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__30795;
limit__$1 = G__30796;
parts = G__30797;
continue;
...
*/
clojure.string.trim = (function trim(s){var G__30799 = s;return goog.string.trim(G__30799);
});
/**
* Removes whitespace from the left side of string.
*/
clojure.string.triml = (function triml(s){var G__30801 = s;return goog.string.trimLeft(G__30801);
});
/**
* Removes whitespace from the right side of string.
*/
clojure.string.trimr = (function trimr(s){var G__30803 = s;return goog.string.trimRight(G__30803);
});
/**
...
*/
clojure.string.blank_QMARK_ = (function blank_QMARK_(s){var G__30806 = s;return goog.string.isEmptySafe(G__30806);
});
/**
...
{var ch = s.charAt(index);var temp__4124__auto___30807 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4124__auto___30807))
{var replacement_30808 = temp__4124__auto___30807;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_30808)));
} else
{buffer.append(ch);
}
{
