...
{return s.replace((new RegExp((function (){var G__30484 = match;return goog.string.regExpEscape(G__30484);
})(),"g")),replacement);
} else
...
{{
var G__30485 = cljs.core.pop(v__$1);
v__$1 = G__30485;
continue;
}
} else
...
{var pred__30493 = cljs.core._EQ_;var expr__30494 = limit;if(cljs.core.truth_((function (){var G__30496 = (1);var G__30497 = expr__30494;return (pred__30493.cljs$core$IFn$_invoke$arity$2 ? pred__30493.cljs$core$IFn$_invoke$arity$2(G__30496,G__30497) : pred__30493.call(null,G__30496,G__30497));
})()))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((function (){var G__30498 = (2);var G__30499 = expr__30494;return (pred__30493.cljs$core$IFn$_invoke$arity$2 ? pred__30493.cljs$core$IFn$_invoke$arity$2(G__30498,G__30499) : pred__30493.call(null,G__30498,G__30499));
})()))
...
var G__30503 = s__$1.substring((index + cljs.core.count(m)));
var G__30504 = (limit__$1 - (1));
var G__30505 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__30503;
limit__$1 = G__30504;
parts = G__30505;
continue;
...
*/
clojure.string.trim = (function trim(s){var G__30507 = s;return goog.string.trim(G__30507);
});
/**
* Removes whitespace from the left side of string.
*/
clojure.string.triml = (function triml(s){var G__30509 = s;return goog.string.trimLeft(G__30509);
});
/**
* Removes whitespace from the right side of string.
*/
clojure.string.trimr = (function trimr(s){var G__30511 = s;return goog.string.trimRight(G__30511);
});
/**
...
*/
clojure.string.blank_QMARK_ = (function blank_QMARK_(s){var G__30514 = s;return goog.string.isEmptySafe(G__30514);
});
/**
...
{var ch = s.charAt(index);var temp__4124__auto___30515 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4124__auto___30515))
{var replacement_30516 = temp__4124__auto___30515;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_30516)));
} else
{buffer.append(ch);
}
{
var G__30517 = (index + (1));
index = G__30517;
continue;
}
}
