...
datascript.btset.cut_n_splice = (function cut_n_splice(arr,cut_from,cut_to,splice_from,splice_to,xs){var arr_l = arr.length;var xs_l = xs.length;var l1 = (splice_from - cut_from);var l2 = (cut_to - splice_to);var l1xs = (l1 + xs_l);var new_arr = (new Array(((l1 + xs_l) + l2)));var n__20998__auto___36842 = l1;var i_36843 = (0);while(true){
if((i_36843 < n__20998__auto___36842))
...
var n__20998__auto___36845 = xs_l;var i_36846 = (0);while(true){
if((i_36846 < n__20998__auto___36845))
...
var n__20998__auto___36848 = l2;var i_36849 = (0);while(true){
if((i_36849 < n__20998__auto___36848))
...
datascript.btset.merge_n_split = (function merge_n_split(a1,a2){var a1_l = a1.length;var a2_l = a2.length;var total_l = (a1_l + a2_l);var r1_l = datascript.btset.half(total_l);var r2_l = (total_l - r1_l);var r1 = (new Array(r1_l));var r2 = (new Array(r2_l));var n__20998__auto___36851 = total_l;var i_36852 = (0);while(true){
if((i_36852 < n__20998__auto___36851))
...
datascript.btset.eq_arr = (function eq_arr(a1,a1_from,a1_to,a2,a2_from,a2_to,cmp){var len = (a1_to - a1_from);var and__19325__auto__ = (len === (a2_to - a2_from));if(and__19325__auto__)
{var i = (0);while(true){
if((i === len))
{return true;
} else
...
{if(cljs.core.truth_((function (){var and__19325__auto__ = left;if(cljs.core.truth_(and__19325__auto__))
...
{if(cljs.core.truth_((function (){var and__19325__auto__ = right;if(cljs.core.truth_(and__19325__auto__))
...
var or__19347__auto__ = self__.root.lookup(k);if(cljs.core.truth_(or__19347__auto__))
...
{var h__20183__auto____$1 = cljs.core.hash_iset(coll__$1);self__.__hash = h__20183__auto____$1;
