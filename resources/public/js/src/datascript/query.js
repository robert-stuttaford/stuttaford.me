...
datascript.query.Context.cljs$lang$ctorPrSeq = (function (this__20561__auto__){return cljs.core._conj(cljs.core.List.EMPTY,"datascript.query/Context");
});
datascript.query.Context.cljs$lang$ctorPrWriter = (function (this__20561__auto__,writer__20562__auto__){return cljs.core._write(writer__20562__auto__,"datascript.query/Context");
});
...
datascript.query.Relation.cljs$lang$ctorPrSeq = (function (this__20561__auto__){return cljs.core._conj(cljs.core.List.EMPTY,"datascript.query/Relation");
});
datascript.query.Relation.cljs$lang$ctorPrWriter = (function (this__20561__auto__,writer__20562__auto__){return cljs.core._write(writer__20562__auto__,"datascript.query/Relation");
});
...
datascript.query.join_tuples = (function join_tuples(t1,idxs1,t2,idxs2){var l1 = idxs1.length;var l2 = idxs2.length;var res = (new Array((l1 + l2)));var n__20998__auto___37102 = l1;var i_37103 = (0);while(true){
if((i_37103 < n__20998__auto___37102))
...
var n__20998__auto___37105 = l2;var i_37106 = (0);while(true){
if((i_37106 < n__20998__auto___37105))
...
datascript.query.prod_rel = (function prod_rel(rel1,rel2){var attrs1 = cljs.core.keys(new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(rel1));var attrs2 = cljs.core.keys(new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(rel2));var idxs1 = cljs.core.to_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(rel1),attrs1));var idxs2 = cljs.core.to_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(rel2),attrs2));return (new datascript.query.Relation(cljs.core.zipmap(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(attrs1,attrs2),cljs.core.range.cljs$core$IFn$_invoke$arity$0()),(function (){var iter__20763__auto__ = ((function (attrs1,attrs2,idxs1,idxs2){
...
{var xs__4624__auto__ = temp__4126__auto__;var t1 = cljs.core.first(xs__4624__auto__);var iterys__20759__auto__ = ((function (s__37120__$1,t1,xs__4624__auto__,temp__4126__auto__,attrs1,attrs2,idxs1,idxs2){
...
{var c__20761__auto__ = cljs.core.chunk_first(s__37122__$2);var size__20762__auto__ = cljs.core.count(c__20761__auto__);var b__37124 = cljs.core.chunk_buffer(size__20762__auto__);if((function (){var i__37123 = (0);while(true){
if((i__37123 < size__20762__auto__))
{var t2 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__20761__auto__,i__37123);cljs.core.chunk_append(b__37124,datascript.query.join_tuples(t1,idxs1,t2,idxs2));
{
...
;var fs__20760__auto__ = cljs.core.seq(iterys__20759__auto__(new cljs.core.Keyword(null,"tuples","tuples",-676032639).cljs$core$IFn$_invoke$arity$1(rel2)));if(fs__20760__auto__)
{return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__20760__auto__,iter__37119(cljs.core.rest(s__37120__$1)));
} else
{{
...
;return iter__20763__auto__(new cljs.core.Keyword(null,"tuples","tuples",-676032639).cljs$core$IFn$_invoke$arity$1(rel1));
})()));
});
/**
* @param {...*} var_args
...
if(cljs.core.truth_((function (){var and__19325__auto__ = tuple__$1;if(cljs.core.truth_(and__19325__auto__))
{return pattern__$1;
} else
{return and__19325__auto__;
}
...
datascript.query.filter_by_pred = (function filter_by_pred(context,clause){var vec__37207 = clause;var vec__37208 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37207,(0),null);var f = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37208,(0),null);var args = cljs.core.nthnext(vec__37208,(1));var pred = (function (){var or__19347__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(datascript.query.built_ins,f);if(cljs.core.truth_(or__19347__auto__))
...
datascript.query.bind_by_fn = (function bind_by_fn(context,clause){var vec__37215 = clause;var vec__37216 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37215,(0),null);var f = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37216,(0),null);var args = cljs.core.nthnext(vec__37216,(1));var out = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37215,(1),null);var fun = (function (){var or__19347__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(datascript.query.built_ins,f);if(cljs.core.truth_(or__19347__auto__))
{return or__19347__auto__;
} else
{return datascript.query.context_resolve_val(context,f);
}
...
{var c__20761__auto__ = cljs.core.chunk_first(s__37246__$2);var size__20762__auto__ = cljs.core.count(c__20761__auto__);var b__37248 = cljs.core.chunk_buffer(size__20762__auto__);if((function (){var i__37247 = (0);while(true){
if((i__37247 < size__20762__auto__))
{var branch = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__20761__auto__,i__37247);var vec__37259 = branch;var vec__37260 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37259,(0),null);var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37260,(0),null);var rule_args = cljs.core.nthnext(vec__37260,(1));var clauses = cljs.core.nthnext(vec__37259,(1));var replacements = cljs.core.zipmap(rule_args,call_args);cljs.core.chunk_append(b__37248,clojure.walk.postwalk(((function (i__37247,vec__37259,vec__37260,_,rule_args,clauses,replacements,branch,c__20761__auto__,size__20762__auto__,b__37248,s__37246__$2,temp__4126__auto__,vec__37244,rule,call_args,seqid,branches){
return (function (p1__37220_SHARP_){if(datascript.query.free_var_QMARK_(p1__37220_SHARP_))
{var or__19347__auto__ = (function (){var G__37262 = p1__37220_SHARP_;return (replacements.cljs$core$IFn$_invoke$arity$1 ? replacements.cljs$core$IFn$_invoke$arity$1(G__37262) : replacements.call(null,G__37262));
...
});})(i__37247,vec__37259,vec__37260,_,rule_args,clauses,replacements,branch,c__20761__auto__,size__20762__auto__,b__37248,s__37246__$2,temp__4126__auto__,vec__37244,rule,call_args,seqid,branches))
,clauses));
{
...
return (function (p1__37220_SHARP_){if(datascript.query.free_var_QMARK_(p1__37220_SHARP_))
{var or__19347__auto__ = (function (){var G__37266 = p1__37220_SHARP_;return (replacements.cljs$core$IFn$_invoke$arity$1 ? replacements.cljs$core$IFn$_invoke$arity$1(G__37266) : replacements.call(null,G__37266));
})();if(cljs.core.truth_(or__19347__auto__))
{return or__19347__auto__;
} else
{return cljs.core.symbol.cljs$core$IFn$_invoke$arity$1((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name(p1__37220_SHARP_))+"__auto__"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(seqid)));
...
;return iter__20763__auto__(branches);
});
...
;return iter__20763__auto__(prev_call_args);
});
...
var G__37393 = (function (){var iter__20763__auto__ = ((function (acc,rels,symbols,copy_map,len,keep_attrs,rel,temp__4124__auto__){
...
{var xs__4624__auto__ = temp__4126__auto__;var t1 = cljs.core.first(xs__4624__auto__);var iterys__20759__auto__ = ((function (s__37380__$1,acc,rels,symbols,t1,xs__4624__auto__,temp__4126__auto__,copy_map,len,keep_attrs,rel,temp__4124__auto__){
...
{var c__20761__auto__ = cljs.core.chunk_first(s__37382__$2);var size__20762__auto__ = cljs.core.count(c__20761__auto__);var b__37384 = cljs.core.chunk_buffer(size__20762__auto__);if((function (){var i__37383 = (0);while(true){
if((i__37383 < size__20762__auto__))
{var t2 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__20761__auto__,i__37383);cljs.core.chunk_append(b__37384,(function (){var res = cljs.core.aclone(t1);var n__20998__auto___37396 = len;var i_37397 = (0);while(true){
if((i_37397 < n__20998__auto___37396))
...
{var t2 = cljs.core.first(s__37382__$2);return cljs.core.cons((function (){var res = cljs.core.aclone(t1);var n__20998__auto___37402 = len;var i_37403 = (0);while(true){
if((i_37403 < n__20998__auto___37402))
...
;var fs__20760__auto__ = cljs.core.seq(iterys__20759__auto__(new cljs.core.Keyword(null,"tuples","tuples",-676032639).cljs$core$IFn$_invoke$arity$1(rel)));if(fs__20760__auto__)
{return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__20760__auto__,iter__37379(cljs.core.rest(s__37380__$1)));
} else
{{
...
;return iter__20763__auto__(acc);
})();
...
,cljs.core.butlast(args));var f__$1 = (function (){var or__19347__auto__ = (function (){var G__37416 = f;return (datascript.query.built_in_aggregates.cljs$core$IFn$_invoke$arity$1 ? datascript.query.built_in_aggregates.cljs$core$IFn$_invoke$arity$1(G__37416) : datascript.query.built_in_aggregates.call(null,G__37416));
})();if(cljs.core.truth_(or__19347__auto__))
{return or__19347__auto__;
} else
{return datascript.query.context_resolve_val(context,f);
...
;var grouped = cljs.core.group_by(group_fn,resultset);var iter__20763__auto__ = ((function (group_idxs,group_fn,grouped){
...
{var c__20761__auto__ = cljs.core.chunk_first(s__37431__$2);var size__20762__auto__ = cljs.core.count(c__20761__auto__);var b__37433 = cljs.core.chunk_buffer(size__20762__auto__);if((function (){var i__37432 = (0);while(true){
if((i__37432 < size__20762__auto__))
{var vec__37438 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__20761__auto__,i__37432);var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37438,(0),null);var tuples = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37438,(1),null);cljs.core.chunk_append(b__37433,datascript.query._aggregate(q,context,tuples));
{
...
;return iter__20763__auto__(grouped);
});
