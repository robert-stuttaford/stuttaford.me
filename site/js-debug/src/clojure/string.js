...
{return s.replace((new RegExp((function (){var G__47732 = match;return goog.string.regExpEscape(G__47732);
})(),"g")),replacement);
} else
...
{{
var G__47733 = cljs.core.pop(v__$1);
v__$1 = G__47733;
continue;
}
} else
...
{var pred__47741 = cljs.core._EQ_;var expr__47742 = limit;if(cljs.core.truth_((function (){var G__47744 = (1);var G__47745 = expr__47742;return (pred__47741.cljs$core$IFn$_invoke$arity$2 ? pred__47741.cljs$core$IFn$_invoke$arity$2(G__47744,G__47745) : pred__47741.call(null,G__47744,G__47745));
})()))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((function (){var G__47746 = (2);var G__47747 = expr__47742;return (pred__47741.cljs$core$IFn$_invoke$arity$2 ? pred__47741.cljs$core$IFn$_invoke$arity$2(G__47746,G__47747) : pred__47741.call(null,G__47746,G__47747));
})()))
...
var G__47751 = s__$1.substring((index + cljs.core.count(m)));
var G__47752 = (limit__$1 - (1));
var G__47753 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__47751;
limit__$1 = G__47752;
parts = G__47753;
continue;
...
*/
clojure.string.trim = (function trim(s){var G__47755 = s;return goog.string.trim(G__47755);
});
/**
* Removes whitespace from the left side of string.
*/
clojure.string.triml = (function triml(s){var G__47757 = s;return goog.string.trimLeft(G__47757);
});
/**
* Removes whitespace from the right side of string.
*/
clojure.string.trimr = (function trimr(s){var G__47759 = s;return goog.string.trimRight(G__47759);
});
/**
...
*/
clojure.string.blank_QMARK_ = (function blank_QMARK_(s){var G__47762 = s;return goog.string.isEmptySafe(G__47762);
});
/**
...
{var ch = s.charAt(index);var temp__4124__auto___47763 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4124__auto___47763))
{var replacement_47764 = temp__4124__auto___47763;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_47764)));
} else
{buffer.append(ch);
}
{
var G__47765 = (index + (1));
index = G__47765;
continue;
}
}
